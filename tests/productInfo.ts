...
describe('loading passing product info', function () {
  ...
  before('load product info', async function () {
    try {
      await v.productInfo.loadFromFileSystem('tests/products/blender-default-cube-passing.json');
    } catch (err) {
...
describe('loading failing product info', function () {
  ...
  before('load product info', async function () {
    try {
      await v.productInfo.loadFromFileSystem('tests/products/blender-default-cube-failing.json');
    } catch (err) {
