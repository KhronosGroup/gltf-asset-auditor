...
export interface ModelInterface {
  ...
  colorValueMax: LoadableAttributeInterface<number>;
  colorValueMin: LoadableAttributeInterface<number>;
  fileSizeInKb: LoadableAttributeInterface<number>;
  glb: GlbInterface;
  gltfValidatorReport: GltfValidatorReportInterface;
  hardEdgeCount: LoadableAttributeInterface<number>;
  ...
  loaded: boolean;
  materialCount: LoadableAttributeInterface<number>;
  maxUvDensity: LoadableAttributeInterface<number>;
  meshCount: LoadableAttributeInterface<number>;
  minUvDensity: LoadableAttributeInterface<number>;
  overlappingUvCount: LoadableAttributeInterface<number>;
  nodeCount: LoadableAttributeInterface<number>;
  nonManifoldEdgeCount: LoadableAttributeInterface<number>;
  primitives: PrimitiveInterface[];
  primitiveCount: LoadableAttributeInterface<number>;
  rootNodeTransform: NodeTransformInterface;
  texturesMaxHeight: LoadableAttributeInterface<number>;
  texturesMaxWidth: LoadableAttributeInterface<number>;
  texturesMinHeight: LoadableAttributeInterface<number>;
  texturesMinWidth: LoadableAttributeInterface<number>;
  triangleCount: LoadableAttributeInterface<number>;
  scene: Scene;
  u: {
