...
export interface SchemaInterface {
  ...
  loaded: boolean;
  maxFileSizeInKb: LoadableAttributeInterface<number>;
  maxHeight: LoadableAttributeInterface<number>;
  maxLength: LoadableAttributeInterface<number>;
  maxMaterialCount: LoadableAttributeInterface<number>;
  maxMeshCount: LoadableAttributeInterface<number>;
  maxNodeCount: LoadableAttributeInterface<number>;
  maxPixelsPerMeter: LoadableAttributeInterface<number>;
  maxPrimitiveCount: LoadableAttributeInterface<number>;
  maxTextureHeight: LoadableAttributeInterface<number>;
  maxTextureWidth: LoadableAttributeInterface<number>;
  maxTriangleCount: LoadableAttributeInterface<number>;
  maxWidth: LoadableAttributeInterface<number>;
  minFileSizeInKb: LoadableAttributeInterface<number>;
  minHeight: LoadableAttributeInterface<number>;
  minLength: LoadableAttributeInterface<number>;
  minMaterialCount: LoadableAttributeInterface<number>;
  minMeshCount: LoadableAttributeInterface<number>;
  minNodeCount: LoadableAttributeInterface<number>;
  minPixelsPerMeter: LoadableAttributeInterface<number>;
  minPrimitiveCount: LoadableAttributeInterface<number>;
  minTextureHeight: LoadableAttributeInterface<number>;
  minTextureWidth: LoadableAttributeInterface<number>;
  minWidth: LoadableAttributeInterface<number>;
  pbrColorMax: LoadableAttributeInterface<number>;
  pbrColorMin: LoadableAttributeInterface<number>;
  percentToleranceHeight: LoadableAttributeInterface<number>;
  percentToleranceLength: LoadableAttributeInterface<number>;
  percentToleranceWidth: LoadableAttributeInterface<number>;
  requireBeveledEdges: LoadableAttributeInterface<boolean>;
  requireCleanRootNodeTransform: LoadableAttributeInterface<boolean>;
  requireManifoldEdges: LoadableAttributeInterface<boolean>;
  requireNotInvertedUVs: LoadableAttributeInterface<boolean>;
  requireNotOverlappingUVs: LoadableAttributeInterface<boolean>;
  requireTextureDimensionsBePowersOfTwo: LoadableAttributeInterface<boolean>;
  requireTextureDimensionsBeQuadratic: LoadableAttributeInterface<boolean>;
  requireUVRangeZeroToOne: LoadableAttributeInterface<boolean>;
  resolutionNeededForUvMargin: LoadableAttributeInterface<number>;
  uvGutterWidth256: LoadableAttributeInterface<number>;
  uvGutterWidth512: LoadableAttributeInterface<number>;
  uvGutterWidth1024: LoadableAttributeInterface<number>;
  uvGutterWidth2048: LoadableAttributeInterface<number>;
  uvGutterWidth4096: LoadableAttributeInterface<number>;
  version: LoadableAttributeInterface<string>;
  getAttributes(): LoadableAttributeInterface<any>[];
...
export class Schema implements SchemaInterface {
  ...
  version = new LoadableAttribute('Version', '1.0.4');
